...
public class ContractSent extends Fragment implements MainActivity.PushDataToFragment {
...
//    private String mParam2;
    ...
    public static ContractSent newInstance(/*String param1, String param2*/) {
        ContractSent fragment = new ContractSent();
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_contract_sent, container, false);

        txHashView = view.findViewById(R.id.contractTxHash);
